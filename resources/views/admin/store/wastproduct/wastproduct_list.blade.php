        ...
        <div class="card mb-2">
            <div class="card-header" style="background-color: #f8f9fa; border-radius: 12px 12px 0 0;">
                <h6 class="mb-0 text-dark">
                    <span>Waste Product List</span>
                </h6>
            </div>
            <div class="card-body">
                <form action="{{ route('wastproduct_list') }}" method="GET" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="filter-actions">
                            <a href="{{ route('wastproduct') }}" class="btn btn-success btn-sm">
                                <i class="fa fa-plus me-1"></i> Add Waste Product
                            </a>
                        </div>
                        ...
                        <div class="filter-actions">
                            <a href="{{ route('wastproduct_list') }}" class="btn btn-warning btn-sm">
                    ...
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('wastproduct_edit', $waste->id) }}"
                                                    class="btn btn-primary" title="Edit Waste Product">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <a href="{{ route('wastproduct_delete', $waste->id) }}"
                                                    class="btn btn-danger" title="Delete Waste Product"
                        ...
                        <div class="d-flex justify-content-between align-items-center p-3 border-top">
                            <div class="d-flex align-items-center">
                                @if ($wastproduct instanceof \Illuminate\Pagination\LengthAwarePaginator)
                                    <span class="text-muted me-3">
                                        Showing {{ $wastproduct->firstItem() }} to {{ $wastproduct->lastItem() }} of
                                        {{ $wastproduct->total() }} assets
                                    </span>
                                @else
                                    <span class="text-muted me-3">Showing all {{ $wastproduct->count() }} assets</span>
                                @endif
