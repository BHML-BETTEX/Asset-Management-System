                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="form_need" name="brand" class="form-control" required="required"
                                            data-error="Please specify your need.">
                                            @foreach ($all_brands as $all_brands)
                                                <option value="{{ $all_brands->id }}"
                                                    {{ $all_brands->id == $all_store->brand ? 'selected' : '' }}>
                                        ...
                                        <select id="form_need" name="units" class="form-control">
                                            @foreach ($all_SizeMaseurment as $all_SizeMaseurment)
                                                <option value="{{ $all_SizeMaseurment->id }}"
                                                    {{ $all_SizeMaseurment->id == $all_store->units ? 'selected' : '' }}>
                                        ...
                                        <select id="form_need" name="company" class="form-control">
                                            @foreach ($all_company as $all_company)
                                                <option value="{{ $all_company->id }}"
                                                    {{ $all_company->id == $all_store->company ? 'selected' : '' }}>
                                        ...
                                        <select id="form_need" name="location" class="form-control" required="required"
                                            ...
                                            @foreach ($all_departments as $all_departments)
                                                <option value="{{ $all_departments->id }}"
                                                    ...
                                                    {{ $all_departments->department_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <select id="form_need" name="status" class="form-control" data-error="status">
                                            @foreach ($all_status as $all_status)
                                                <option value="{{ $all_status->id }}"
                                                    {{ $all_status->id == $all_store->status ? 'selected' : '' }}>
