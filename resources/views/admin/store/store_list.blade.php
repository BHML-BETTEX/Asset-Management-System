...
<div class="container">
    <div class="page-title">
        ...
        <div class="modal fade bd-example-modal-xl" id="addProductModal" tabindex="-1" role="dialog"
                                            ...
                                            <form action="{{ route('store.store') }}" Method="POST"
                                                ...
                                                <div class="controls">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="form_label">Brand <span
                                                                        class="text-danger">* <span class="text-success" data-toggle="modal" data-target="#addBrandModal"><i
                                                                                class="fa fa-plus"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="form_label">Units </span><button type="button" class="text-success" data-toggle="modal" data-target="#addUnitModal"><i
                                                                            class="fa fa-plus"
                                                                            style="font-size:10px;"></button></i></label>
        ...
        <div class="modal fade bd-example-modal-xl" id="addBrandModal" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade bd-example-modal-xl" id="addUnitModal" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                    <div class="modal-header">
