                                        ...
                                        <form action="{{ route('store.store') }}" Method="POST"
                                            ...
                                            <div class="controls">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_label">Asset Type <span class="">*
                                                            ...
                                                            <select id="form_need" name="asset_type" class="form-control"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_label">Brand <span class="text-danger">* <a
                                                                        class="text-success" href="{{ route('brand') }}"><i
                                                                            class="fa fa-plus"
                                                                            style="font-size:10px;"></a></i></span>
                                                            </label>
                                                            <select id="form_need" name="brand" class="form-control"
                                                                required="required"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="" type="text" name="asset_sl_no"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_label">Currency </span><a class="text-success"
                                                                    href=""><i class="fa fa-plus"
                                                                        style="font-size:10px;"></a></i></label>
                                                            <select id="form_need" name="currency" class="form-control"
                                                                required="required" data-error="brand">
                                                                <option value="" selected disabled>--Select Your
                                                                    Issue--</option>
                                                                <option>BDT</option>
                                                                <option>USD</option>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="form_need">Durablity </span><a
                                                                    class="text-success" href=""><i
                                                                        class="fa fa-plus"
                                                                        style="font-size:10px;"></a></i></label>
                                                            <select id="form_label" name="durablity" class="form-control"
                                                                required="required" data-error="brand">
                                                                <option value="" selected disabled>--Select Your
                                                                    Issue--</option>
                                                                <option>Days</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_label">Units </span><a class="text-success"
                                                                    href=""><i class="fa fa-plus"
                                                                        style="font-size:10px;"></a></i></label>
                                                            <select id="form_label" name="units" class="form-control">
                                                                <option value="" selected disabled>--Select Your
                                                                    Issue--</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="" type="date" name="purchase_date"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_label">Vendor </span><a class="text-success"
                                                                    href=""><i class="fa fa-plus"
                                                                        style="font-size:10px;"></a></i></label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_label">Company </span><a class="text-success"
                                                                    href=""><i class="fa fa-plus"
                                                                        style="font-size:10px;"></a></i></label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_label">Location<span class="text-danger">*
                                                                </span><a class="text-success" href=""><i
                                                                        class="fa fa-plus"
                                                                        style="font-size:10px;"></a></i></span></label>
                                                            <select id="form_need" name="location" class="form-control"
                                                                required="required" data-error="location">
                                                                <option value="" selected disabled>--Select Your
                                                                    Issue--</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="form_label">Status </span><a class="text-success"
                                                                    href=""><i class="fa fa-plus"
                                                                        style="font-size:10px;"></a></i></label>
                                                            <select id="form_need" name="status" class="form-control"
                                                                data-error="status">
                                                                <option value="" selected disabled>--Select Your
                                                                    Issue--</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="" type="text" name="challan_no"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <tbody style="height: 5px !important; overflow: scroll; ">
                                @foreach ($stores as $key => $store)
                                    <tr>
                                        ...
                                        <td><img width="50" height="25" src="{{ asset('/uploads/store/' . $store->picture) }}"
                                                alt="picture"></td>
                                        <td>
                                            <button class="border-0 bg-white"><a class="text-primary"
                                                    href="{{ route('store.edit', $store->id) }}"><i class="fa fa-edit "
                                            ...
                                            <button class="border-0 bg-white"><a class="text-success"
                                                    href="{{ route('invoice', $store->id) }}"><i class="fa fa-eye "
                                                        style="font-size:20px;"></a></i></button>
                                        </td>
                                    </tr>
                                @endforeach
