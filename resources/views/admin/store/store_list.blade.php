        ...
        <div class="card-body py-2">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex flex-wrap gap-2" id="columnToggles">
                    <!-- Column toggles will be generated by JavaScript -->
                </div>
            </div>
        </div>
    </div>
...
function initializeColumnSelector() {
    ...
    headers.each(function() {
        ...
        const toggleBtn = $(`
            <button type="button"
                    class="btn btn-outline-primary btn-sm column-toggle"
                    data-column="${columnName}"
                    title="Toggle ${columnText} column"
                    ${isEssential ? 'data-essential="true"' : ''}>
                <i class="fa fa-eye"></i> ${columnText}
            </button>
        `);
...
function toggleColumn(columnName) {
    ...
    const toggleBtn = $(`.column-toggle[data-column="${columnName}"]`);
    const isVisible = columnElements.is(':visible');
...
function showAllColumns() {
    ...
    const toggleButtons = $('.column-toggle');

    allColumns.show();
    toggleButtons.removeClass('btn-outline-secondary').addClass('btn-outline-primary');
    toggleButtons.find('i').removeClass('fa-eye-slash').addClass('fa-eye');
...
function hideAllColumns() {
    ...
    const nonEssentialToggleButtons = $('.column-toggle:not([data-essential="true"])');

    nonEssentialColumns.hide();
    nonEssentialToggleButtons.removeClass('btn-outline-primary').addClass('btn-outline-secondary');
    nonEssentialToggleButtons.find('i').removeClass('fa-eye').addClass('fa-eye-slash');
...
function resetToDefault() {
    ...
    allColumns.hide();
    toggleButtons.removeClass('btn-outline-primary').addClass('btn-outline-secondary');
    toggleButtons.find('i').removeClass('fa-eye').addClass('fa-eye-slash');
...
function saveColumnPreferences() {
    ...
    $('.column-toggle').each(function() {
        const columnName = $(this).data('column');
        const isVisible = $(`.smart-table table [data-column="${columnName}"]`).is(':visible');
        if (isVisible) {
...
function loadColumnPreferences() {
    ...
    try {
        ...
        const toggleButtons = $('.column-toggle:not([data-essential="true"])');

        allColumns.hide();
        toggleButtons.removeClass('btn-outline-primary').addClass('btn-outline-secondary');
        toggleButtons.find('i').removeClass('fa-eye').addClass('fa-eye-slash');

        // Show saved visible columns
