            ...
            <div class="col-xl-6 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group input-group-outline mb-3">
                            <input type="text" id="asset_type"  class="form-control " value="" name="asset_type" readonly>
                        </div>

                        <div class="input-group input-group-outline mb-3">
                            <input type="text" id="model"  class="form-control " value="" name="model" readonly>
                        </div>
                        ...
                        <div class="input-group input-group-outline mb-3">
                            ...
                            <input type="text" id="emp_name" class="form-control" value=""
                        ...
                        <div class="input-group input-group-outline mb-3">
                            <textarea class="form-control" id="textAreaExample6" rows="3" placeholder="Resaon For Transfer"></textarea>
                        </div>
