...
@section('content')
    <div class="container">
                            ...
                            <div class="card-header">
                                ...
                                @if (session('delete_success'))
                                    <div class="alert alert-danger alert-dismissible fade show d-flex justify-content-between align-items-center"
                                        ...
                                        <button type="button" class="border-0 bg-danger text-white fw-bold px-2 rounded"
                                            data-bs-dismiss="alert" aria-label="Close">X</button>
                                    </div>
                                @endif
                    ...
                    <div class="row">
                        <div class="info-stack-container p-2">
                            <div class="col-md-3 col-xs-12 col-lg-12 col-sm-push-9 info-stack">
                                <div class="col-lg-12">
                                    <img src="https://bxasset.bettex.com/public/uploads/avatars/setting-default_avatar-1-7tjaWAl05r.png"
                                        class=" img-thumbnail hidden-print" style="margin-bottom: 20px;"
                                        alt="Nadia Shahrin Chandni">
                                </div>
                                <div class="col-lg-12" style="padding-top: 2px;">
                                    <a href="{{ route('store.edit', $stores->id) }}"
                                        class="btn btn-block btn-sm btn-info btn-social hidden-print">
                                ...
                                <div class="col-lg-12" style="padding-top: 2px;">
                                    <a href="{{ route('store.clone', $stores->id) }}"
                                        class="btn btn-block btn-sm btn-primary btn-social hidden-print">
       ...
       @if ($stores->checkstatus != 'INSTOCK') disabled opacity-50 pointer-events-none @endif"
                                ...
                                <div class="col-lg-12" style="padding-top: 2px;">
                                    <a href="{{ route('qr_code_view', $stores->id) }}"
                                        class="btn btn-block btn-sm btn-secondary btn-social hidden-print">
                                        <i class="fa fa-eye me-1"></i> QR View
                                    </a>
                                </div>

                                <div class="col-lg-12" style="padding-top: 2px;">
                                    <a href="{{ route('qr_code', $stores->id) }}"
                                        class="btn btn-block btn-sm btn-info btn-social hidden-print">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="archiveModalLabel">Archive Asset</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('store.archive.post', $stores->id) }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="archive_comment" class="form-label">Archive Comment (Optional)</label>
                        <textarea class="form-control" id="archive_comment" name="archive_comment" rows="3" placeholder="Enter a comment for archiving this asset..."></textarea>
                    </div>
                    <p class="text-muted">Are you sure you want to archive this asset? This action cannot be undone.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-warning">Archive Asset</button>
                </div>
            </form>
        </div>
    </div>
