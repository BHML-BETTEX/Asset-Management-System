                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="asset_tag"
                                        value="{{ $maintenance_data->asset_tag ?? '' }}" readonly>
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label class="form-label fw-bold">Asset Type</label>
                                    <input type="text" class="form-control" name="asset_type"
                                        value="{{ $maintenance_data->rel_to_ProductType->product ?? '' }}" readonly>
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label class="form-label fw-bold">Model</label>
                                    <input type="text" class="form-control" name="model"
                                        value="{{ $maintenance_data->model ?? '' }}" readonly>
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label class="form-label fw-bold">Purchase Date</label>
                                    <input type="text" class="form-control" name="purchase_date"
                                        value="{{ $maintenance_data->purchase_date ?? '' }}" readonly>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="strat_date"
                                        value="{{ $maintenance_data->strat_date ?? '' }}" required>
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label class="form-label fw-bold">Note</label>
                                    <input type="text" class="form-control" name="note"
                                        value="{{ $maintenance_data->note ?? '' }}">
                                </div>
                            </div>

                            <!-- Back and Submit buttons -->
                            <div class="d-flex justify-content-between mt-4">
                                <a href="{{ route('maintenance_list', ['store_id' => $stores->id]) }}"
