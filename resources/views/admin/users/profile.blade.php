                        ...
                        <div class="row align-items-center">
                            <div class="col-md-2 text-center">
                                <div class="profile-photo-wrapper">
                                    @if (!empty(Auth::user()->picture) && file_exists(public_path('uploads/profile_photos/' . Auth::user()->picture)))
                                    ...
                                    @else
                                        <img src="{{ asset('uploads/profile_photos/default.png') }}"
                                            alt="Default Profile Photo" class="profile-photo-large">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                <div class="profile-info">
                                    ...
                                    <h6 class="profile-email">
                                        <i class="fa fa-envelope me-2"></i> {{ Auth::user()->email }}
                                    </h6>
                                    <h6 class="profile-joined">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <p class="text-muted mb-0">Update your personal information, change password, or upload a
                                    new profile photo</p>
                            </div>
    ...
    <script>
        ...
        function editMyProfile() {
            $.ajax({
                ...
                beforeSend: function() {
                    $('#editProfileContent').html(
                        '<div class="text-center p-4"><i class="fa fa-spinner fa-spin fa-2x"></i><p class="mt-2">Loading profile information...</p></div>'
                    );
                },
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#changePasswordContent').html(
                        '<div class="text-center p-4"><i class="fa fa-spinner fa-spin fa-2x"></i><p class="mt-2">Loading password change form...</p></div>'
                    );
                },
                success: function(response) {
                    if (response.success) {
