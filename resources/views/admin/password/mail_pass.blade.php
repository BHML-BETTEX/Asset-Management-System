            ...
            <div class="row ">
                <div class="col-md-12">
                    <div class="col-md-5 p-2">
                        <h5 class="text-white">Mail Password List</h5>
                    </div>
                    <div class="col-md-1">
                    ...
                    <div class="col-md-2 ">
                        <form action="{{route('mail_export')}}" method="GET">
                            <div class="input-group">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close btn-border-none" data-bs-dismiss="modal"
