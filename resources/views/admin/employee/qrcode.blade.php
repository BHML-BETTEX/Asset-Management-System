    ...
    <tr>
        ...
        <td>
            <table style="width: 350px; font-size: 10pt; font-family: Arial, sans-serif;" cellpadding="0" cellspacing="0">
              <tbody>    
              <tr>
                <td style="font-size: 12pt; font-family: Arial, sans-serif; padding-left: 10px;"> <span style="text-transform:uppercase; font-size: 12pt; font-family: Arial Black; color:#06A5CC;"> {{$qrCode->name}}</span><br>
                      <span style="font-size: 10pt; font-family: Arial, sans-serif; color:#5D6D7E;"><strong> {{$qrCode->designation}} || {{$qrCode->department}}<br>
                      <span style="font-size: 10pt; font-family: Arial, sans-serif; color:#5D6D7E;"><strong>{{$qrCode->phone}}<br>
