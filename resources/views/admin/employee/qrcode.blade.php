                    ...
                    <tbody>
                        <tr>
                            <td style="font-size: 12pt; font-family: Arial, sans-serif; padding-left: 10px;"> <strong> <span style="text-transform:uppercase; font-size: 12pt; font-family: Arial Black; color:#06A5CC;"> {{$employee->emp_name}}</span><br>
                                <span style="font-size: 10pt; font-family: Arial, sans-serif; color:#5D6D7E;">{{$employee->rel_to_designation->designation_name}} || {{$employee->rel_to_departmet->department_name}}<br>
                                        <span style="font-size: 10pt; font-family: Arial, sans-serif; color:#5D6D7E;">{{$employee->phone_number}}<br>
