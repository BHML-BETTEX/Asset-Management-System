                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            ...
                                            onclick="window.location='{{ route('departments_asset', $employee->department_id) }}'">
                                            {{ $employee->rel_to_departmet->department_name }}
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            ...
                                            {{ $employee->rel_to_companies->company }}
                                        </span>
                    ...
                    <div class="info-stack-container p-2">
                        <div class="col-md-3 col-xs-12 col-lg-12 col-sm-push-9 info-stack">
                            ...
                            <div class="col-lg-12" style="padding-top: 5px;">
                                <a href="{{ route('employee_edit', $employee->id) }}" class="btn btn-block btn-sm btn-info btn-social hidden-print">
