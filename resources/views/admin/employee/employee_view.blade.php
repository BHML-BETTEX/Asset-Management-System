                                ...
                                <div class="card-body p-4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 p-5 m-auto">
                                            ...
                                            <h5 class="mb-2 pb-1 ">{{$employee_show->rel_to_designation->designation_name}} || {{$employee_show->rel_to_departmet->department_name}}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-12 mx-auto">
                <div class="card">
                    ...
                    <div class="card-body" style="background-color:#DDEAFC ;">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                <a href="tel:<?php echo $employee_show["phone"]; ?>" class="media contact-details-item">
                    ...
                    <div class="card-header text-white" style="background-color:#337ca6;">
                        <a class="text-white text-center" href="https://bettex.com.bd/">
                            <h4>BHML INDUSTRIES LTD.</h4>
                        </a>
                    </div>
                </div>
            </div>
